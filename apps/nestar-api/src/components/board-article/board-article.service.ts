...
export class BoardArticleService {
    ...
    public async getBoardArticle(memberId:ObjectId, articleId:ObjectId):Promise<BoardArticle> {
        ...
        if(memberId){
            ...
            if(newView){
                await this.boardArticlesStatsEditor({ _id: articleId, targetKey:'articleViews', modifier:1 })
...
//Like BoardArticle
     public async likeTargetBoardArticle(memberId:ObjectId, likeRefId:ObjectId):Promise<BoardArticle> {
            ...
            const result = await this.boardArticlesStatsEditor({_id: likeRefId, targetKey:"articleLikes", modifier:modifier })
    ...
    public async boardArticlesStatsEditor(input: StatisticModifier):Promise<BoardArticle> {
